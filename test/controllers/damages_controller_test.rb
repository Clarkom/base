...
class DamagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create damage" do
    assert_difference('Damage.count') do
      post damages_url, params: { damage: { damage_type_id: @damage.damage_type_id, driver_id: @damage.driver_id, expense_id: @damage.expense_id } }
    end
  ...
  test "should update damage" do
    patch damage_url(@damage), params: { damage: { damage_type_id: @damage.damage_type_id, driver_id: @damage.driver_id, expense_id: @damage.expense_id } }
