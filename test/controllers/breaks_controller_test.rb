...
class BreaksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create break" do
    assert_difference('Break.count') do
      post breaks_url, params: { break: { end_date: @break.end_date, expense_id: @break.expense_id, start_date: @break.start_date } }
    end
  ...
  test "should update break" do
    patch break_url(@break), params: { break: { end_date: @break.end_date, expense_id: @break.expense_id, start_date: @break.start_date } }
